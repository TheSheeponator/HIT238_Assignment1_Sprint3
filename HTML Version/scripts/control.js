...
$('#autoFormButton').click(function(evt) {
    ...
    $.post("https://320298.spinetail.cdu.edu.au/comm/command", data, function(data) {
        // refresh db
        console.log(data);
...
$('#manualOFF').click(function(evt) {
    ...
    setAutoButton(0);
    setManualButton(0);
    $.post("https://320298.spinetail.cdu.edu.au/comm/command", {
        loc: CurrentSelection,
        manual: true,
        status: 0,
        cache: false
...
function mapClick(loc, resetEditMessage = true) {
    ...
    $.ajax({
        ...
        dataType: "json",
        url: "https://320298.spinetail.cdu.edu.au/comm/getStatus",
...
$('#editForm').on('submit', (e) => {
    ...
    $.ajax({
        ...
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        url: "https://320298.spinetail.cdu.edu.au/comm/changeSettings",
        data: JSON.stringify(postdata),
        success: (response) => {
